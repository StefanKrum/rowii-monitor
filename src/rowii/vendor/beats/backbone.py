...
# --------------------------------------------------------
#
# Vendored into rowii-monitor on 2026-07-07 from
# repos/pshp-ssl-transfer/src/pshp/core/encoders/ssl/vendor/beats/backbone.py,
# itself a copy of microsoft/unilm's beats/backbone.py. See `modules.py`'s
# header and `rowii.signals.beats_model`'s module docstring for full
# provenance/rationale. Source: https://github.com/microsoft/unilm/tree/master/beats
#
# ONE substantive change from upstream: `from modules import (...)` (a
# sys.path hack in the original) is `from .modules import (...)` (a proper
# relative import, since this file lives in a real Python package here) --
